...
class LLMClient:
    ...
    def generate_completion(
        ...
        **kwargs,
        ...
        if not self.is_available():
            raise LLMError(
                "OpenAI client is not available. Check API key configuration."
            )
    ...
    def generate_documentation(
        self, code: str, language: str = "python", doc_type: str = "docstring"
    ) -> str:
        """
    ...
    def suggest_improvements(
        self, code: str, focus_area: str = "general", language: str = "python"
    ) -> str:
        """
