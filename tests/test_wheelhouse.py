...
class TestWheelhouseClient:
    ...
    def test_client_initialization_missing_keys(self):
        ...
        config = Config(
            wheelhouse_api_key=None, wheelhouse_user_api_key="test_user_key"
        )
    ...
    def test_get_listings_success(self, client, sample_listing_data, mock_requests):
        ...
        mock_requests.add_response(json_data=sample_listing_data, status_code=200)
    ...
    def test_get_listings_with_filters(
        self, client, sample_listing_data, mock_requests
    ):
    ...
    def test_rate_limit_handling(self, client, mock_requests):
        ...
        # Second succeeds
        mock_requests.add_response(
            json_data={"listings": [], "total": 0}, status_code=200
        )
    ...
    def test_api_error_handling(self, client, mock_requests):
        ...
        mock_requests.add_response(
            json_data={"error": "Invalid date format"}, status_code=400
        )
    ...
    def test_get_listing_details(self, client, mock_requests):
        ...
        mock_requests.add_response(json_data=listing_detail, status_code=200)
    ...
    def test_health_check_success(self, client, mock_requests):
        ...
        mock_requests.add_response(json_data={"status": "ok"}, status_code=200)
    ...
    def test_health_check_failure(self, client, mock_requests):
        ...
        mock_requests.add_response(status_code=500)
    ...
    def test_retry_exhaustion(self, client, mock_requests):
        ...
        for _ in range(6):  # More than max retries
            mock_requests.add_response(status_code=429, headers={"Retry-After": "1"})
