...
class TestETLProcessor:
    ...
    def test_process_date_success(self, mock_get_listings, etl_processor, sample_listing_data, temp_config):
    ...
    @patch.object(WheelhouseClient, 'get_all_listings_for_date')
    def test_process_date_dry_run(self, mock_get_listings, etl_processor, sample_listing_data):
        """Test dry run mode."""
        mock_get_listings.return_value = sample_listing_data
    ...
    @patch.object(WheelhouseClient, 'get_all_listings_for_date')
    def test_process_date_partial_failure(self, mock_get_listings, etl_processor, temp_config):
    ...
    def test_file_overwrite_behavior(self, etl_processor, sample_listing_data, temp_config):
